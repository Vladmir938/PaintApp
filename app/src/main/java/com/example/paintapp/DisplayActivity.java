...
import static com.example.paintapp.MainActivity.paint_brush;
...
public class DisplayActivity extends View {
    public static ArrayList<Path> pathList = new ArrayList<>();
    public static ArrayList<Integer> colorList = new ArrayList<>();
    public ViewGroup.LayoutParams params;
    public static int current_brush = Color.BLACK;

    public DisplayActivity(Context context) {
        super(context);
        init(context);
    }

    public DisplayActivity(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public DisplayActivity(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
